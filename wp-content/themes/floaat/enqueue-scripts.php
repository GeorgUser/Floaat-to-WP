...
if ( ! function_exists( 'floaat_scripts' ) ) :
	...
	function floaat_scripts() {
        wp_enqueue_style('archivo', '//fonts.googleapis.com/css?family=Archivo:400,700&display=swap', array(), '1.0.0', 'all');
        wp_enqueue_style('archivoBlack', '//fonts.googleapis.com/css?family=Archivo+Black&display=swap', array(), '1.0.0', 'all');
        wp_enqueue_style('main-stylesheet', get_stylesheet_directory_uri().'/dist/styles/main.css', array(), '1.0.0', 'all');

		wp_deregister_script( 'jquery' );
		wp_enqueue_script( 'jquery', '//code.jquery.com/jquery-2.2.4.min.js', [], '2.2.4', true );
